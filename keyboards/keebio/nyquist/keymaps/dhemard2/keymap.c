 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Opt  | Ctrl | Cmd  | FN1  | Shift| Space| FN1  | Cmd  | Ctrl |      |      |
 * `-----------------------------------------------------------------------------------'
 * v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v v
 */
[_QWERTY] = LAYOUT( \
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
  ESC_FN2, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, ENT_FN2, \
  FN3,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
  XXXXXXX, KC_LALT, KC_LCTL, KC_LCMD, FN1,     KC_LSFT, KC_SPC,  FN1,     KC_RCMD, KC_RCTL, XXXXXXX, XXXXXXX, \
 ...
 * |      |      |  F7  |  F8  |  F9  |      |      |      |      |      |      |RGB Tg|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |  F4  |  F5  |  F6  |      |Ctl(L)|      |Ctl(U)|Ctl(R)|      |RGB Md|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | xxxx |      |  F1  |  F2  |  F3  |      |Reset |      |      |Val Dn|Val Up|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |  F10 |  F11 |  F12 |      |      |      |Hue Up|Sat Dn|Sat Up|Hue Dn|
 * `-----------------------------------------------------------------------------------'
 */
[_FN3] = LAYOUT( \
  _______, _______, KC_F7,   KC_F8,   KC_F9,   _______, _______, _______, _______, _______, _______, RGB_TOG, \
  _______, _______, KC_F4,   KC_F5,   KC_F6,   _______, CTRL_L,  _______, CTRL_UP, CTRL_R,  _______,  RGB_MOD, \
  _______, _______, KC_F1,   KC_F2,   KC_F3,   _______, RESET,   _______, _______, RGB_VAD, RGB_VAI, _______, \
  _______, _______, KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, RGB_HUD, RGB_SAD, RGB_SAI, RGB_HUI, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),
